...
<aside id="sidebar" class="sidebar">
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a href="kelola_postingan.php" class="nav-link" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
...
<main id="main" class="main">
  <div class="pagetitle">
    <div class="pagetitle">
      ...
      <form action="controlers/postinganCONTROLER.PHP" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="judul" class="form-label">Judul:</label>
          <input type="text" id="judul" name="judul" class="form-control" required>
        </div>
        <div class="mb-3">
          <label for="konten" class="form-label">Isi Postingan:</label>
          <textarea id="konten" name="konten" class="form-control" rows="6" required></textarea>
        </div>
        <div class="mb-3">
