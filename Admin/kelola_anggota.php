...
// Memeriksa apakah terdapat baris data anggota yang ditemukan
if ($row) {
    // Menampilkan tombol cetak untuk baris data pertama
    echo "<a href='print/print_anggota.php?id=" . $row['id_anggota'] . "' class='btn btn-success' target='_blank'>Print</a>";
} else {
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // Perbaikan tombol print dengan menyertakan ID anggota dalam URL
    echo "<td><a href='update/edit_anggota.php?id=" . $row['id_anggota'] . "' class='btn btn-sm btn-primary'>Edit</a> | <a href='update/hapus_anggota.php?id=" . $row['id_anggota'] . "' onclick='return confirm(\"Apa anda yakin ingin menghapus anggota ini ?\");' class='btn btn-sm btn-danger'>Hapus</a></td></tr>";
}
mysqli_close($conn);
?>
