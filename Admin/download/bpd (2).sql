...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Bulan Mei 2024 pada 19.00
...
INSERT INTO `rapat` (`id_rapat`, `nama`, `tanggal`, `topik`, `hasil_rapat`, `waktu`, `status`, `nomor_rapat`, `tempat_rapat`) VALUES
(4, 'contoh nama rapat', '2024-05-06', 'contoh topik', 0, '03:56:00', 'Belum Selesai', '12345', 'desa bulila');
...
--
ALTER TABLE `peraturan_desa`
  MODIFY `id_peraturan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `postingan`
--
ALTER TABLE `postingan`
  MODIFY `id_postingan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
