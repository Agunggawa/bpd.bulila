    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Kelola Foto Bagan</li>
            </ol>
            <a href="tambah_bagan.php" class="btn btn-primary">Tambah Struktur</a>
        </nav>
    </div><!-- End Page Title -->
...
$query = "SELECT * FROM bagan";
$result = mysqli_query($conn, $query);
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tr>";
    echo "<td><img src='" . htmlspecialchars($row['foto_bagan']) . "' style='max-width: 100px; max-height: 100px;'></td>";
    echo "<td><a href='update/hapus_struktur.php?id=" . $row['id_bagan'] . "' onclick='return confirm(\"Apa anda yakin ingin menghapus bagan ?\");' class='btn btn-sm btn-danger'>Delete</a></td>";
