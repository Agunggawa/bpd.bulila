...
<section class="section dashboard">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="controlers/rapatCONTROLER.PHP" method="post" class="row g-3">
    <div class="col-md-6">
        <label for="nomor_rapat" class="form-label">Nomor Rapat:</label>
        <input type="text" class="form-control" id="nomor_rapat" name="nomor_rapat" required>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <textarea id="topik" name="topik" class="form-control" rows="6" required></textarea>
    </div>
    <div class="col-md-12">
        <label for="hasil" class="form-label">Hasil rapat:</label>
        <textarea id="hasil" name="hasil_rapat" class="form-control" rows="6" required></textarea>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-12">
    <label for="tempat_rapat" class="form-label">Tempat Rapat :</label>
    <input type="text" class="form-control" id="tempat_rapat" name="tempat_rapat" required>
</div>
